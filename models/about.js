...
export const experiencesLists = [
    ...
    {
        position: 'DATA ANALYTICS',
        location: 'KHAZANAH NASIONAL (EXECELERATE), MALAYSIA',
        startDate: '2025-09-03T00:00:00Z',
        endDate: '2025-09-30T00:00:00Z',
    },
    {
        position: 'FREELANCER',
        location: 'SONTIQO & CO., MALAYSIA',
...
export const awardsLists = [
    {
        title: 'SILVER AWARD AT 14TH CREATION, INNOVATION, TECHNOLOGY & RESEARCH EXPOSITION (CITREX) 2024',
    },
    {
        title: 'BRONZE AWARD FOR UNDERGRADUATE PROJECT',
    }
];

export const educationsLists = [
    {
